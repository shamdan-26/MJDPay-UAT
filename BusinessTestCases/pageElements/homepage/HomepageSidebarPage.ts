...
export class HomepageSidebarPage {
    ...
    readonly moneySectionLabel: Locator;
    readonly manageSectionLabel: Locator;
    ...
    constructor(page: Page) {
        ...
        this.moneySectionLabel  = page.locator('#sideNav-sidenav').getByText(/^money$/i).first();
        this.manageSectionLabel = page.locator('#sideNav-sidenav').getByText(/^manage$/i).first();
